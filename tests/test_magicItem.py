...
class TestMagicItem:
    def test_creation(self):
        new_item = item.MagicItem(name='Sword', magic='+1', weight=5.0, value=10.0, category='weapon', dmg=125)
        ...
        assert new_item.id == 'weapon|Sword|+1', 'ID is incorrectly generated.'
    ...
    def test_str(self):
        new_item = item.MagicItem(name='Sword', magic='+1', weight=5.0, value=10.0, category='weapon')
